...
public final class Dictionaries {
	...
	private static synchronized void load() {
		...
		try {
			Dictionaries.dictionary = TokenInfoDictionary.newInstance();
			Dictionaries.unknownDictionary = UnknownDictionary.newInstance();
			Dictionaries.costs = ConnectionCosts.newInstance();
			Dictionaries.trie = DoubleArrayTrie.newInstance();
