...
//			builder.readDictionaryCSVFile(Configuration.getSourceDictionaryDirname() + File.separator + "Verb.csv");
...
//		TokenInfoDictionaryBuilder builder = new TokenInfoDictionaryBuilder();
//		TokenInfoDictionary dictionary =
//			builder.readDictionaryDirectory(Configuration.getSourceDictionaryDirname());
//		System.out.println(dictionary);
	}
