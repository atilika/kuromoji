...
public class DictionaryEntry extends AbstractDictionaryEntry {
    ...
    public DictionaryEntry(String[] fields) {
        ...
        kana = fields[DictionaryField.KANA];
        kanaBase = fields[DictionaryField.KANA_BASE];
        form = fields[DictionaryField.FORM];
        formBase = fields[DictionaryField.FORM_BASE];
        initialConnectionType = fields[DictionaryField.INITIAL_CONNECTION_TYPE];
        finalConnectionType = fields[DictionaryField.FINAL_CONNECTION_TYPE];

        accentType = fields[DictionaryField.ACCENT_TYPE];
        accentConnectionType = fields[DictionaryField.ACCENT_CONNECTION_TYPE];
